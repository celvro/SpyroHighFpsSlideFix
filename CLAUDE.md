...
- `ue4ss/Mods/HighFpsSlidingAndJumpFix` — the shipped fixes (braking slide + jump height), a UE4SS Lua mod published as "High FPS Sliding and Jump Fix" (`VERSION` constant in `main.lua`; player-facing `README.txt` ships in the mod folder)
